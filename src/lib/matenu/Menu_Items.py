...
if Globals.FirstUse:
	os.system("/bin/sh -c %s'/lib/%s/MateNu-Settings.py --welcome' &" % (INSTALL_PREFIX, Globals.appdirname))
...
class XDMateMenu(gobject.GObject):
	...
	def ConstructMenu(self):
		...
		#==============================================================
			...
			self.addtomenu(_("MateNu settings utility"),"%slogo.png" % Globals.GraphicsDirectory,7,"","%sMateNu-Settings.py" % Globals.ProgramDirectory)
		#==============================================================
